...
abstract final class int extends num {
  ...
  ///
  /// On the web, this value is first converted to a 32-bit integer by
  /// truncating to the least significant 32 bits in the binary representation
  /// of the number. On native platforms, the 64-bit signed integer is used
  /// directly.
  ///
